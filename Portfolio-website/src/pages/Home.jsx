      ...
      <div className="flex flex-col justify-center h-screen">
        <div className="flex flex-col-reverse md:flex-row justify-center w-full h-full">
          <div className="flex flex-col items-center justify-center w-full md:w-1/2 p-9 text-center md:text-left">
            ...
            <img src="/south-africa (1)-modified.png" alt="wavyUnderline" width="71px" class="absolute"/>
      <img src="/closed-book-with-bookmark-modified.png" alt="wavyUnderline" width="71px" class="absolute"/>
      <img src="/console-modified.png" alt="wavyUnderline" width="71px" class="absolute"/>
      <img src="/sweater-modified.png" alt="wavyUnderline" width="71px" class="absolute"/>
