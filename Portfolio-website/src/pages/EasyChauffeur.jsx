    ...
    <>
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-5">
        <div className="flex flex-col lg:flex-col justify-center align-center content-center items-center ">
          <h1 className="text-5xl mb-7 px-10">Landing, Fleet and Booking Page</h1>
          <p className='px-10'>The landing page consists of a simple but effective and easy to view layout, giving potential clients an easy understanding of the service as well as specific details to build trust while also supplying reasons as to why use EasyChauffeur over competitors. 
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-5">
          ...
          <div className="columns-2 ml-5 mr-5 lg:mr-0 order-last lg:order-first">
            <div className="flex flex-col">
          ...
          <div className="flex flex-col lg:flex-col justify-center align-center content-center items-center ">
            <h1 className="text-5xl mb-7">Payment Pages</h1>
            <p className='px-10'>
            The payment pages are simple and easy to use, with the client being able to easily input their details 
            with google maps api helping by automatically complete addresses. Clients are also then shown the route on the interactable map
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-5 ">
          <div className="flex flex-col lg:flex-col justify-center align-center content-center items-center ml-5">
            <h1 className="text-5xl mb-7">Managing Bookings Pages</h1>
            <p className='px-10'>
            The managing bookings pages are simple and easy to use, with the client being able to easily input their email and quickly find all of their bookings.<br/>
          ...
          <div className="columns-2 mr-5 ml-5 lg:ml-0">
            <div className="flex flex-col">
